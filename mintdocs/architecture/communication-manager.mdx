...
All messages in the system use `UnifiedMessage` — the canonical cross-channel format defined in `hiro-channel-sdk`. Every channel plugin translates its native format to and from this model.
