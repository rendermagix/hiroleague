...
The Agent Manager loads all registered PHB tools at startup via `all_tools()` and makes them available to the agent. The agent can invoke any of these tools as part of processing a message.
