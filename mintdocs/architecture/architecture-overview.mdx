---
title: "Overview"
description: "The core concepts behind Private Home Box and how they fit together."
icon: "sitemap"
---

Private Home Box (PHB) is a personal AI infrastructure that runs on your own hardware. Your desktop runs the agents, owns all your data, and manages all connected devices and services.
...
The Root Node is your desktop machine — the central computer running Private Home Box. It is the owner of all data, the authority for authentication, and the host for one or more workspaces.
...
A device node is any client that connects to Private Home Box — a mobile app, a web browser, another desktop. Device nodes communicate with the server through a Gateway, and can send messages, receive agent responses, or report device state.
