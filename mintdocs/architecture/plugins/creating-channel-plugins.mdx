...
description: "How to write, install, and configure a new PHB channel plugin."
icon: "code"
---

This guide walks you through writing a new PHB channel plugin from scratch. A plugin connects a third-party messaging platform — Telegram, WhatsApp, your mobile app, or anything else — to the Private Home Box server.
