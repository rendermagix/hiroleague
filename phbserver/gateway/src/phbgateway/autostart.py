"""Auto-start registration wrappers for phbgateway instances."""
...
def register_autostart(instance_name: str) -> AutostartMethod:
    return commons_register_autostart(
        instance_name,
        entry_name_prefix="phbgateway",
        executable_name="phbgateway",
...
def unregister_autostart(instance_name: str) -> None:
    commons_unregister_autostart(instance_name, entry_name_prefix="phbgateway")


def unregister_autostart_elevated(instance_name: str) -> bool:
    return commons_unregister_autostart_elevated(instance_name, entry_name_prefix="phbgateway")
